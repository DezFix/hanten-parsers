...
internal class DgMangaParserTest {

	private val parser = MangaLoaderContextMock.newParserInstance(MangaParserSource.DGMANGA)
	...
	@Test
	fun search() = runTest {
		val list = parser.getList(0, SortOrder.UPDATED, MangaListFilter(query = "кривавий"))
