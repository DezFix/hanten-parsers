...
internal class MangaLibComParserTest {

	private val parser = MangaLoaderContextMock.newParserInstance(MangaParserSource.MANGALIB_COM)
	...
	@Test
	fun search() = runTest {
		val list = parser.getList(0, SortOrder.UPDATED, MangaListFilter(query = "терраса"))
