...
internal class MangaddictParserTest {

	private val parser = MangaLoaderContextMock.newParserInstance(MangaParserSource.MANGADDICT)
	...
	@Test
	fun search() = runTest {
		val list = parser.getList(0, SortOrder.UPDATED, MangaListFilter(query = "solo leveling"))
