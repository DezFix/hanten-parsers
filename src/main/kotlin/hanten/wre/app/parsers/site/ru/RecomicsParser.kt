...
@MangaSourceParser("RECOMICS", "ReComics", "ru")
internal class RecomicsParser(
	context: MangaLoaderContext,
) : PagedMangaParser(context, MangaParserSource.RECOMICS, PAGE_SIZE), MangaParserAuthProvider, Interceptor {
	...
	override val configKeyDomain = ConfigKey.Domain("recomics.org")
	...
	override suspend fun getRelatedManga(seed: Manga): List<Manga> {
		...
		val json = webClient.httpGet(
			// https://api.recomics.org/api/v2/titles/the_beginning_after_the_end/relations/
