package hanten.wre.app.parsers.ksp
...
class ParserProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("hanten.wre.app.parsers.MangaSourceParser")
        ...
        val factoryFile =
            try {
                codeGenerator.createNewFile(
                    ...
                    packageName = "hanten.wre.app.parsers",
        ...
        val sourcesFile =
            try {
                codeGenerator.createNewFile(
                    dependencies = dependencies,
                    packageName = "hanten.wre.app.parsers.model",
    ...
    private fun writeContent(
        ...
        factoryWriter?.write(
			...
			import hanten.wre.app.parsers.core.MangaParserWrapper
